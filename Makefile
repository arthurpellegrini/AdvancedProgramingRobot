...
main_SRCS = $(SRC_DIR)/main.cpp $(SRC_DIR)/ConnectToServer.cpp $(SRC_DIR)/LaserScanHandler.cpp $(SRC_DIR)/OdometryHandler.cpp $(SRC_DIR)/CommanderHandler.cpp $(SRC_DIR)/SharedMemory.cpp $(SRC_DIR)/VisualizeDataHandler.cpp
